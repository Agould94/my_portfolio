                ...
                <Box sx ={{display:"flex", flexDirection:"column", justifyContent:"center", paddingLeft:2, paddingRight:2}}>
                    <Box sx={{display:"flex", justifyContent:"center", paddingBottom:2}}>
                        <FormControl sx={{width:"60%"}} variant="standard">
                            <TextField label="Full Name" id="name" name="name"></TextField>
                        </FormControl>
                    </Box>
                    <Box sx={{display:"flex", justifyContent:"center", paddingBottom:2}}>
                        <FormControl sx={{width:"60%"}} variant="standard">
                            <TextField label= "email" type="email" id="email" name="email"></TextField>
                        </FormControl>
                    </Box>
                    <Box sx={{display:"flex", justifyContent:"center", paddingLeft:2, paddingRight:2}}>
                        <FormControl fullWidth="true">
                            <TextField id="message" label="Message" name="message" multiline="true" rows={4}></TextField>
                        </FormControl>
                    </Box>
